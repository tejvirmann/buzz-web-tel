import type { BlobView, CommitInfo, ReadmeResult, TreeEntry } from "./git-client";
...
export const mockRepos: Repo[] = [
  ...
  },
  {
    id: "agent-harness",
    name: "agent-harness",
    description: "Tools and shared workflows for launching and coordinating coding agents.",
  ...
  },
  {
    ...
    description: "Infrastructure and deployment configuration for community relays.",
...
export function getMockBlob(repoId: string, filepath: string): BlobView | undefined {
