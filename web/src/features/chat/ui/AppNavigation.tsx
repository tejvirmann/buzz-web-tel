      ...
      <nav className="hidden w-[60px] shrink-0 flex-col items-center border-r border-black/5 py-3 md:flex dark:border-white/5">
        ...
        <div className="mt-6 flex flex-col gap-1">
          ...
          >
            ...
            {inboxUnreadCount ? (
              <span className="absolute -right-1 -top-1 flex min-h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[9px] font-semibold text-primary-foreground">
