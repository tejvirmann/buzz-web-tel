import { ArchiveRestore, Compass, Hash, LoaderCircle, Lock, Search, Users } from "lucide-react";
...
export function ChannelBrowserDialog({
  ...
  return (
    <DialogFrame title={t("channel.browserTitle")} width="max-w-2xl" onClose={onClose}>
