/** localStorage key used to hand the name typed on the claim page to the main app for a one-time kind:0 publish. */
export const PENDING_PROFILE_NAME_KEY = "buzz-pending-profile-name";
